...
fn splash_uses_stonr_logo_asset() {
    ...
    assert!(index_html.contains("assets/icons/meta/territory-master.png?v=stonr-control-20260417d"));
    ...
    assert!(index_html.contains("style.css?v=stonr-control-20260417d"));
    assert!(index_html.contains("app.js?v=stonr-control-20260417d"));
    assert!(style_css.contains(".boot-mark {"));
    assert!(style_css.contains("object-fit: contain;"));
    assert!(style_css.contains("-webkit-clip-path: polygon("));
    assert!(style_css.contains("clip-path: polygon("));
